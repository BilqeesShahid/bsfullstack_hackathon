  ...
  return (
    <div>
      <Container className="flex flex-col md:flex-row gap-10 py-10">
        {product?.image && (
          <div className="w-full md:w-1/2 h-auto border border-blue-900/20 shadow-md rounded-md group overflow-hidden">
            <Image
              ...
              height={700}
              priority
              className="w-full max-h-[550] object-cover group-hover:scale-110 hoverEffect rounded-md"
            />
          </div>
        )}
        <div className="w-full md:w-1/2 flex flex-col gap-5">
                ...
                {Array.from({ length: 5 }).map((_, index) => {
                  ...
                  return (
                    <LuStar
                      ...
                      key={index}
                      className={`${isLastStar ? "text-gray-500" : "text-orange-500"}`}
                    />
                  );
                })}
              </div>
          ...
          <div className="flex flex-wrap items-center gap-5">
            <div className="border border-blue-900/20 text-center p-3 hover:border-blue-900 hoverEffect rounded-md">
